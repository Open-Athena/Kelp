...
![](https://cdn.bsky.app/img/avatar/plain/did:plc:lozmph3nfogiyoi23m4qrxus/bafkreih3yuiy7zkmfiaakfvperqt4nmq5pu7nqovkijje2fukahbwx55wq){.slide-img}

* Monterey Bay, California
* Founding Member of Techical Staff at Open Athena
* I create ocean physics emulators with Laure Zanna (NYU) & Abigail Bodner (MIT)
  * See [m2lines.github.io/Samudra](https://m2lines.github.io/Samudra/)
* Previously: Google Research (ML weather models, provable privacy)
* Previously: CogSci & Computer Science at UCSD
...
## Kelp today — a longer repair path (3 planted bugs, 3 edits)

![](assets/kelp_repair_663.gif)

## Kelp today — every intermediate state is valid Python

![](assets/kelp_repair_874.gif)
