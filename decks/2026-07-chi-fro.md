...
![](assets/arc_tour4.jpg){.slide-img}
...
* ![](assets/oa.png){.logo} OA is a non-profit AI lab that partners with academia to tackle fundamental science challenges using the capabilities at the AI frontier.   
* ![](assets/marin-logo.svg){.logo} A large component of OA is Marin, a community created by Percy Liang at Stanford to create an open development process for making frontier LLMs.
...
* Core to all: **token documents**… and what is a program if not a token document?
...
* How do we represent larger programs? How do we represent state?
